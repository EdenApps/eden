...
class TestUi(TestExpenseCommon, HttpCase):
    ...
    def test_show_expense_receipt_on_expense_line_click(self):
        ...
        self.start_tour('/eden', 'show_expense_receipt_tour', login=self.env.user.login)
    ...
    def test_expense_manager_can_always_set_employee(self):
        ...
        self.start_tour('/eden', 'create_expense_no_employee_access_tour', login=self.expense_user_manager.login)
    ...
    def test_not_create_zero_amount_expense_in_expense_sheet(self):
        ...
        with mute_logger("eden.http"):
            self.start_tour('/eden', 'do_not_create_zero_amount_expense_in_sheet', login=self.env.user.login)
