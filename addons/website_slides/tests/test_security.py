...
class TestAccess(common.SlidesCase):
    ...
    @mute_logger('eden.models', 'eden.addons.base.models.ir_rule')
...
class TestAccessFeatures(common.SlidesCase):
    ...
    @mute_logger('eden.models.unlink', 'eden.addons.base.models.ir_rule', 'eden.addons.base.models.ir_model')
...
class TestReview(common.SlidesCase, HttpCase):
    ...
    def test_channel_multiple_reviews(self):
        ...
        self.assertIn("eden.exceptions.ValidationError", res2.text)
