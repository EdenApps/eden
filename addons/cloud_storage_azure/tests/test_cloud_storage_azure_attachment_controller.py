...
from eden.addons.cloud_storage_azure.tests.test_cloud_storage_azure import (
...
class TestCloudStorageAttachmentController(
    ...
    def test_cloud_storage_azure_attachment_upload(self):
        ...
        with patch(
            "eden.addons.cloud_storage_azure.utils.cloud_storage_azure_utils.requests.post", post
        ):
                            ...
                            "ir.attachment": [
                                {
                                    ...
                                    "create_date": eden.fields.Datetime.to_string(
