...
import { click, manuallyDispatchProgrammaticEvent, press, waitFor } from "@eden/hoot-dom";
 ...
 * @param {string} html
 */
export function pasteEdenEditorHtml(editor, html) {
    return pasteData(editor, html, "application/vnd.eden.eden-editor");
}
/**
 * @param {Node} node
 */
