...
/**
 * @typedef { Object } CollaborationEdenShared
 * @property { CollaborationEdenPlugin['getPeerMetadata'] } getPeerMetadata
 */

export class CollaborationEdenPlugin extends Plugin {
    static id = "collaborationEden";
            ...
            onNotification: async (notification) => {
                ...
                switch (notificationName) {
                    ...
                    case "ptp_disconnect":
                        ...
                        // todo: to implement
                        // this.edenEditor.multiselectionRemove(fromPeerId);
                        break;
