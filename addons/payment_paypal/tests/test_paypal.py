...
from eden.addons.payment_paypal.tests.common import PaypalCommon
...
class PaypalTest(PaypalCommon, PaymentHttpCommon):
    ...
    def test_processing_values(self):
        ...
        with patch(
            'eden.addons.payment_paypal.models.payment_provider.PaymentProvider'
            '._paypal_make_request', return_value={'id': self.order_id},
        ):
            processing_values = tx._get_processing_values()
        self.assertEqual(processing_values['order_id'], self.order_id)

    @mute_logger('eden.addons.payment_paypal.controllers.main')
    ...
    def test_webhook_notification_confirms_transaction(self):
        ...
        with patch(
            'eden.addons.payment_paypal.controllers.main.PaypalController'
