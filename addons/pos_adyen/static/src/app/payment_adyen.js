...
export class PaymentAdyen extends PaymentInterface {
    ...
    _handle_eden_connection_failure(data = {}) {
        // handle timeout
        ...
        this._show_error(
            _t(
                "Could not connect to the Eden server, please check your internet connection and try again."
            )
        );
    ...
    _call_adyen(data, operation = false) {
        return this.pos.data
            ...
            .catch(this._handle_eden_connection_failure.bind(this));
    }
    ...
    async handleAdyenStatusResponse() {
        ...
        if (!notification) {
            this._handle_eden_connection_failure();
            return;
        }
