...
from eden.tools.mail import email_domain_extract, url_domain_extract
...
class ResCompany(models.Model):
    ...
    def _enrich(self):
        ...
        if additional_data:
            ...
            template_values['flavor_text'] = _("Company auto-completed by Eden Partner Autocomplete Service")
