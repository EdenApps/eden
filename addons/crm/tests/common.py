...
from eden.addons.crm.models.crm_lead import PARTNER_ADDRESS_FIELDS_TO_SYNC
from eden.addons.mail.tests.common import MailCase, mail_new_test_user
...
class TestLeadConvertCommon(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.crm_lead_dt_patcher = patch('eden.addons.crm.models.crm_lead.fields.Datetime', wraps=Datetime)
