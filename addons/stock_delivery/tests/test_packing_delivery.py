...
from eden.addons.stock.tests.test_packing import TestPackingCommon
...
class TestPacking(TestPackingCommon):
    ...
    def test_multistep_delivery_tracking(self):
        ...
        with patch(
            'eden.addons.stock_delivery.models.delivery_carrier.DeliveryCarrier.fixed_send_shipping',
