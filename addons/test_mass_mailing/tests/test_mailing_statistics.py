...
from eden.addons.test_mass_mailing.data.mail_test_data import MAIL_TEMPLATE
...
class TestMailingStatistics(TestMassMailCommon):
    ...
    @mute_logger('eden.addons.mass_mailing.models.mailing', 'eden.addons.mail.models.mail_mail', 'eden.addons.mail.models.mail_thread')
    def test_mailing_statistics(self):
        ...
        self.gateway_mail_trace_click(mailing, target_records[0], 'https://www.eden.be')
        self.gateway_mail_trace_click(mailing, target_records[2], 'https://www.eden.be')
        self.gateway_mail_trace_click(mailing, target_records[3], 'https://www.eden.be')
