...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("EdenBeforeTestHook", "EdenAfterTestHook"); // Eden customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("EdenBeforeTestHook"); // Eden customization
