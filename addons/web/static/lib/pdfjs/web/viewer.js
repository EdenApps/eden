...
class BasePreferences {
  ...
  #defaults = Object.freeze({
    ...
    // Eden: don't support scripting (#115302)
    enableScripting: false,
    // Eden: disable stamp editor
    enableStampEditor: false,
    // Eden: open links in new tabs to keep eden document (#84594)
  ...
  try {
    ...
    activeService.renderPages().then(function () {
      ...
      if (activeServiceOnEntry.active) {
        // EDEN Patch: https://github.com/mozilla/pdf.js/issues/10630#issuecomment-855754913
