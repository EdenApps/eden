/** @eden-module alias=@web/../tests/qunit default=false */
...
import { Component, whenReady } from "@eden/owl";
...
export function setupQUnit() {
    ...
    QUnit.done(async (result) => {
        await eden.loader.checkErrorProm;
    ...
    QUnit.begin(function () {
        if (eden.debug && eden.debug.includes("assets")) {
    ...
    QUnit.on("EdenAfterTestHook", (info) => {
