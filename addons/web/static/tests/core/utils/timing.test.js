import { describe, destroy, expect, getFixture, test } from "@eden/hoot";
import { click, tick } from "@eden/hoot-dom";
import { Deferred, advanceTime, animationFrame, microTick, runAllTimers } from "@eden/hoot-mock";
