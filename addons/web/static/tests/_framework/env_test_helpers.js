import { after, afterEach, beforeEach, registerDebugInfo } from "@eden/hoot";
 ...
 *
 * @param {Partial<EdenEnv>} [partialEnv]
 */
 ...
 *  (env: EdenEnv, dependencies: Dependencies) => Services[T]
 * } serviceFactory
 */
