...
import eden
from eden import fields, exceptions, Command
...
class TestStockValuationWithCOA(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        old_action_post = eden.addons.account.models.account_move.AccountMove.action_post
        old_create = eden.models.BaseModel.create
        ...
        post_patch = patch('eden.addons.account.models.account_move.AccountMove.action_post', new_action_post)
        create_patch = patch('eden.models.BaseModel.create', new_create)
    ...
    def test_realtime_anglo_saxon_valuation_multicurrency_different_dates(self):
        ...
        def _today(*args, **kwargs):
            return date_po
        patchers = [
            patch('eden.fields.Date.context_today', _today),
        ]
    ...
    def test_average_realtime_with_delivery_anglo_saxon_valuation_multicurrency_different_dates(self):
        ...
        patchers = [
            patch('eden.fields.Date.context_today', _today),
            patch('eden.fields.Datetime.now', _now),
        ]
    ...
    def test_incoming_with_negative_qty(self):
        ...
        # it is negative qty transfer so Eden will create delivery instead of receipt.
