...
from eden.addons.sales_team.tests.common import TestSalesMC
from eden.tests.common import users, TransactionCase
...
class TestCornerCases(TransactionCase):
    ...
    def test_unicity(self):
        ...
        with self.assertRaises(exceptions.UserError), mute_logger('eden.sql_db'):
