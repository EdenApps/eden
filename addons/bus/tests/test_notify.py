...
from ..models.bus import json_dump, get_notify_payloads, NOTIFY_PAYLOAD_MAX_LENGTH, EDEN_NOTIFY_FUNCTION
...
class NotifyTests(TransactionCase):
    ...
    def test_postcommit(self):
        ...
        if EDEN_NOTIFY_FUNCTION != 'pg_notify':
            return
        channels = []
