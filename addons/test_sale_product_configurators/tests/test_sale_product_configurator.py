...
class TestProductConfiguratorUi(HttpCase, TestProductConfiguratorCommon):
    ...
    def test_01_product_configurator(self):
        ...
        self.start_tour("/eden", 'sale_product_configurator_tour', login='salesman')
    ...
    def test_02_product_configurator_advanced(self):
        ...
        self.start_tour("/eden", 'sale_product_configurator_advanced_tour', login='salesman')
    ...
    def test_03_product_configurator_edition(self):
        self.start_tour("/eden", 'sale_product_configurator_edition_tour', login='salesman')
    ...
    def test_05_product_configurator_pricelist(self):
        ...
        self.start_tour("/eden", 'sale_product_configurator_pricelist_tour', login='salesman')
    ...
    def test_06_product_configurator_optional_products(self):
        ...
        self.start_tour(
            "/eden", 'sale_product_configurator_optional_products_tour', login='salesman'
        )
    ...
    def test_07_product_configurator_recursive_optional_products(self):
        ...
        self.start_tour(
            "/eden", 'sale_product_configurator_recursive_optional_products_tour', login='salesman'
        )

    def test_product_configurator_update_custom_values(self):
        self.start_tour(
            "/eden", 'sale_product_configurator_custom_value_update_tour', login='salesman',
        )
    ...
    def test_product_attribute_multi_type(self):
        ...
        self.start_tour("/eden", 'product_attribute_multi_type', login="salesman")
