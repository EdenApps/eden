...
from eden.addons.payment_authorize.tests.common import AuthorizeCommon
...
class TestRefundFlows(AuthorizeCommon):
    ...
    def test_refunding_voided_tx_cancels_it(self):
        ...
        with patch(
            'eden.addons.payment_authorize.models.authorize_request.AuthorizeAPI'
    ...
    @mute_logger('eden.addons.payment_authorize.models.payment_transaction')
    def test_refunding_authorized_tx_voids_it(self):
        ...
        with patch(
            ...
            'eden.addons.payment_authorize.models.authorize_request.AuthorizeAPI.void'
        ) as void_mock, patch(
    ...
    def test_refunding_captured_tx_refunds_it_and_creates_refund_tx(self):
        ...
        create a refund transaction on Eden. """
        source_tx = self._create_transaction('direct', state='done')
        with patch(
            'eden.addons.payment_authorize.models.authorize_request.AuthorizeAPI'
            '.get_transaction_details',
            ...
            'eden.addons.payment_authorize.models.authorize_request.AuthorizeAPI.refund'
