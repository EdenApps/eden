...
from eden.addons.mail.models.mail_mail import _UNFOLLOW_REGEX
...
from eden.tools import email_normalize, mail, mute_logger, parse_contact_from_email
...
class UnfollowFromEmailTest(MailCommon, HttpCase):
    ...
    @mute_logger('eden.addons.base.models', 'eden.addons.mail.controllers.mail', 'eden.http', 'eden.models')
    ...
    @mute_logger('eden.addons.mail.controllers.mail', 'eden.models', 'eden.http')
