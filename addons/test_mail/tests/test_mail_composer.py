...
from eden.addons.mail.wizard.mail_compose_message import MailComposer
from eden.addons.test_mail.models.test_mail_models import MailTestTicket
...
from eden.tools import email_normalize, mute_logger, formataddr
...
class TestComposerInternals(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('eden.tests', 'eden.addons.mail.models.mail_mail', 'eden.models.unlink')
    ...
    @mute_logger('eden.tests', 'eden.addons.base.models.ir_rule', 'eden.addons.mail.models.mail_mail', 'eden.models.unlink')
...
class TestComposerResultsComment(TestMailComposer, CronMixinCase):
    ...
    @users('employee')
    @mute_logger('eden.models.unlink', 'eden.addons.mail.models.mail_mail', 'eden.addons.mail.models.mail_message_schedule')
...
class TestComposerResultsMass(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('eden.models.unlink', 'eden.addons.mail.models.mail_mail')
