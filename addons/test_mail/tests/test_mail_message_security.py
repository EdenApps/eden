...
from eden.addons.test_mail.models.mail_test_access import MailTestAccess
...
class TestMailMessageAccess(MessageAccessCommon):
    ...
    @mute_logger('eden.addons.base.models.ir_model', 'eden.addons.base.models.ir_rule')
    ...
    @mute_logger('eden.addons.base.models.ir_rule')
