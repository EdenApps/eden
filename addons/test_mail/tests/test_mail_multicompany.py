...
from eden.addons.test_mail.models.test_mail_corner_case_models import MailTestMultiCompanyWithActivity
from eden.addons.test_mail.tests.common import TestRecipients
from eden.exceptions import AccessError
from eden.tests import tagged, users, HttpCase
            ...
            with self.subTest(login=login, mc_record=mc_record):
                ...
                if not login:
                    ...
                    if mc_error:
                        ...
                        self.assertEqual(parsed_url.path, '/eden/action-mail.action_discuss')
                    else:
