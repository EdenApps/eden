...
From: "Bruce Wayne" <bruce@wayneenterprises.com>
Subject: test
Message-ID: <c0c20fdd-a38e-b296-865b-d9232bf30ce5@eden.com>
...
From: {email_from}
To: {to}
References: <f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@eden.com>
Message-ID: <cb7eaf62-58dc-2017-148c-305d0c78892f@eden.com>
Date: Wed, 14 Mar 2018 14:26:58 +0100
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:52.0) Gecko/20100101
 Thunderbird/52.6.0
MIME-Version: 1.0
In-Reply-To: <f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@eden.com>
Content-Type: multipart/mixed;
...
ARC-Authentication-Results: i=1; mx.google.com;
       dkim=pass header.i=@eden.com header.s=mail header.b=MCzhjB9b;
       spf=pass (google.com: domain of soup@eden.com designates 149.202.180.44 as permitted sender) smtp.mailfrom=soup@eden.com;
       dmarc=pass (p=NONE sp=NONE dis=NONE) header.from=eden.com
Return-Path: <soup@eden.com>
Received: from mail2.eden.com (mail2.eden.com. [149.202.180.44])
        by mx.google.com with ESMTPS id y4si4279200wmy.148.2018.03.05.01.19.22
        (version=TLS1_2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128/128);
        Mon, 05 Mar 2018 01:19:23 -0800 (PST)
Received-SPF: pass (google.com: domain of soup@eden.com designates 149.202.180.44 as permitted sender) client-ip=149.202.180.44;
...
Received: from [10.10.31.24] (unknown [91.183.114.50])
	...
	by mail2.eden.com (Postfix) with ESMTPSA id 7B571A4085
	for <what@eden.com>; Mon,  5 Mar 2018 10:19:21 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple; d=eden.com; s=mail;
...
To: what@eden.com
From: Soup <soup@eden.com>
Subject: =?UTF-8?Q?Soupe_du_jour_:_Pois_cass=c3=a9s?=
Message-ID: <a05d8334-7b7c-df68-c96a-4a88ed19f31b@eden.com>
...
X-Spam-Checker-Version: SpamAssassin 3.4.0 (2014-02-07) on mail2.eden.com
...
Chaussée de Namur, 40
B-1367 Grand Rosière
Web: <a class="moz-txt-link-freetext" href="http://www.edencloud.us">http://www.edencloud.us</a> </pre>
  </body>
</html>
...
Delivered-To: eden+82240-account.invoice-19177@mycompany.example.com
...
X-Eden-Objects: account.invoice-19177
...
.com" style=3D"text-decoration:none; color: white;">
                      ...
                      <tr>
                        <td align=3D"center">
                            Powered by <a href=3D"https://www.edencloud.us">Odo=
o</a>.
                        </td>
                      </tr>
                    </tbody>
...
X-Eden-Objects: project.project-3, ,project.task-32
...
Received: by mailserver.eden.com (Postfix)
...
MIME-Version: 1.0
Content-Type: multipart/report; report-type=delivery-status;
        boundary="DFFDC17AA03.1673346179/mailserver.eden.com"
Message-Id: <40230110102259.EA0B917B8E4@mailserver.eden.com>
Content-Transfer-Encoding: 7bit
Delivered-To: {delivered_to}
Return-Path: <>

--DFFDC17AA03.1673346179/mailserver.eden.com
Content-Description: Notification
Content-Type: text/plain; charset=utf-8
Content-Transfer-Encoding: quoted-printable
...
Reporting-MTA: dns; mailserver.eden.com
X-Postfix-Queue-ID: DFFDC17AA03
X-Postfix-Sender: rfc822; bounce@xxx.eden.com
...
Return-Path: <bounce@xxx.eden.com>
Received: from eupp00.eden.com (00.72.79.34.bc.googleusercontent.com [34.=
79.72.00])
        by mailserver.eden.com (Postfix) with ESMTPS id DFFDC17AA03;
        Tue, 10 Jan 2023 11:22:57 +0100 (CET)
DKIM-Signature: v=3D1; a=3Drsa-sha256; c=3Dsimple/simple; d=3Dxxx.be;
        s=3Deden; t=3D1673346178;
...
rder@xxx.eden.com> <368396033905967.1673346177.695352554321289-openerp-11=
-sale.order@eupp00>
Subject: Thi is a SO (Ref SO/11)
From: info@xxx.eden.com
Reply-To: "SO/11" <catchall@xxx.eden.com=
>
To: "rdesfrdgtfdrfesd@outlook.com" <rdesfrdgtfdrfesd@outlook.com>
Date: Tue, 29 Feb 2023 06:09:06 -0000
X-Eden-Objects: sale.order-11
MIME-Version: 1.0
...
To: "Thai Eden User" <thai-user@eden.com>
