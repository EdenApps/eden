...
from eden.tests import tagged, TransactionCase, Form
from eden.tools import mute_logger

from eden.addons.product.tests.common import ProductVariantsCommon, ProductAttributesCommon
...
class TestVariantsExclusion(ProductAttributesCommon):
    ...
    def test_dynamic_variants_unarchive(self):
        ...
        with patch(
            'eden.addons.product.models.product_product.ProductProduct._filter_to_unlink',
