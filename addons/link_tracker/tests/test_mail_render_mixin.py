...
class TestMailRenderMixin(common.HttpCase):
    ...
    @mute_logger("eden.tests.common.requests")
    def test_shorten_links(self):
        test_links = [
            ...
            '<a href="https://www.edencloud.us?test=%20+3&amp;this=that">THERE > there</a>',
            '<a >Without href</a>'
        ]
        ...
        trackers_to_find = [
            ...
            [("url", "=", self.base_url + '#')],
            [("url", "=", "https://www.edencloud.us?test=%20+3&this=that"), ("label", "=", "THERE > there")],  # lxml unescaped
        ]
        trackers_to_fail = [
    ...
    def test_shorten_links_html_different_labels(self):
        ...
        content = """<p>There is a <a href="https://www.edencloud.us">logo.png</a> here,
<a href="https://www.edencloud.us">there</a>, and in this
<a href="https://www.edencloud.us"><!--[if mso]><img src="https://www.edencloud.us/logo.png" alt="image" style="1"/><![endif]-->
<!--[if !mso]><!--><img src="https://www.edencloud.us/logo.png" style="2" alt="image"/><!--<![endif]--></a>
and also <a href="https://www.edencloud.us">
    <p class="o_outlook_hack" style="text-align: center; margin: 0px;"><img src="https://www.edencloud.us/logo.png" fakealt="image3" alt="image2's trouble"></img></p>
</a>
Single/Nested quotes are not <a href="https://www.edencloud.us"><img src='https://www.edencloud.us/logo.png' alt='"scary"'/></a>
Nor escaped <a href="https://www.edencloud.us">  <img src="https://www.edencloud.us/logo.png" alt="ins \' ide"></a>
Nor escaped <a href="https://www.edencloud.us"> blurp <img src="https://www.edencloud.us/logo.png" alt="ins \' ide"></a>
Without matched label because inside tags are a pain and rare: <a href="https://www.edencloud.us"><em>here</em></a>
Without alt, filename is used: <a href="https://www.edencloud.us"><img src="https://www.edencloud.us/logo.png"></a>
And here is the same: <a href="https://www.edencloud.us"><img src="https://www.edencloud.us/logo.png"></a></p>"""

        expected_pattern = re.compile(
            rf"""<p>There is a <a href="{self.base_url}/r/(\w+)+">logo.png</a> here,
<a href="{self.base_url}/r/(\w+)+">there</a>, and in this
<a href="{self.base_url}/r/(\w+)+"><!--\[if mso]><img src="https://www.edencloud.us/logo.png" alt="image" style="1"/><!\[endif]-->
<!--\[if !mso]><!--><img src="https://www.edencloud.us/logo.png" style="2" alt="image"/><!--<!\[endif]--></a>
and also <a href="{self.base_url}/r/(\w+)+">
    <p class="o_outlook_hack" style="text-align: center; margin: 0px;"><img src="https://www.edencloud.us/logo.png" fakealt="image3" alt="image2\'s trouble"/></p>
</a>
Single/Nested quotes are not <a href="{self.base_url}/r/(\w+)+"><img src="https://www.edencloud.us/logo.png" alt="&quot;scary&quot;"/></a>
Nor escaped <a href="{self.base_url}/r/(\w+)+">  <img src="https://www.edencloud.us/logo.png" alt="ins \' ide"/></a>
Nor escaped <a href="{self.base_url}/r/(\w+)+"> blurp <img src="https://www.edencloud.us/logo.png" alt="ins \' ide"/></a>
Without matched label because inside tags are a pain and rare: <a href="{self.base_url}/r/(\w+)+"><em>here</em></a>
Without alt, filename is used: <a href="{self.base_url}/r/(\w+)+"><img src="https://www.edencloud.us/logo.png"/></a>
And here is the same: <a href="{self.base_url}/r/(\w+)+"><img src="https://www.edencloud.us/logo.png"/></a></p>"""
        )
        ...
        trackers_to_find = [
            [("url", "=", "https://www.edencloud.us"), ("label", "=", "logo.png")],
            [("url", "=", "https://www.edencloud.us"), ("label", "=", "there")],
            [("url", "=", "https://www.edencloud.us"), ("label", "=", "[media] image")],
            [("url", "=", "https://www.edencloud.us"), ("label", "=", "[media] image2's trouble")],
            [("url", "=", "https://www.edencloud.us"), ("label", "=", "blurp")],
            [("url", "=", "https://www.edencloud.us"), ("label", "=", '[media] "scary"')],
            [("url", "=", "https://www.edencloud.us"), ("label", "=", "[media] ins ' ide")],
            [("url", "=", "https://www.edencloud.us"), ("label", "=", False)],
            [("url", "=", "https://www.edencloud.us"), ("label", "=", "[media] logo.png")],
        ]
        for tracker_to_find in trackers_to_find:
            with self.subTest(tracker_to_find=tracker_to_find):
                self.assertTrue(
...
This is another: <a href="{self.base_url}/eden?debug=1&more=2">{self.base_url}</a><br/>
...
And a 6th: <a href="/eden">Here2</a><br>
And a 7th: <a href="{self.base_url}/eden">Here2</a><br>
...
And a last, more complex: <a href="{self.base_url}/r/(\w+)">There!</a>
    ...
    def test_shorten_links_html_skip_shorts(self):
        ...
        new_content = self.env["mail.render.mixin"]._shorten_links(
            f'Reusing this old <a href="{created_short_url}">link</a> with a new <a href="https://edencloud.us">one</a>', {}
        )
        expected = re.compile(
...
This is another: {self.base_url}/eden?debug=1&more=2
...
And a last, with question mark: {self.base_url}/r/(\w+)"""
    ...
    def test_shorten_links_text_skip_shorts(self):
        ...
        new_content = self.env["mail.render.mixin"]._shorten_links_text(
            f'Reusing this old link {created_short_url} with a new one, https://edencloud.us</a>', {}
        )
