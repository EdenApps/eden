...
from eden.tools import config, DEFAULT_SERVER_DATE_FORMAT, DEFAULT_SERVER_DATETIME_FORMAT, parse_version
...
class ImportMapping(models.Model):
    ...
    not match Eden's field names or labels. This model is used
    ...
    def get_fields_tree(self, model, depth=FIELDS_RECURSION_LIMIT):
        ...
        .. class:: Field
            ...
            .. attribute:: name: str
                ...
                The field's logical (Eden) name within the scope of
                its parent.
            ...
            .. attribute:: model_name: str
                ...
                Used in the Eden Field Tooltip on the import view
