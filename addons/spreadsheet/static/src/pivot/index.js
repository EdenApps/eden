...
import { PivotEdenCorePlugin } from "./plugins/pivot_eden_core_plugin";
...
coreTypes.add("UPDATE_EDEN_PIVOT_DOMAIN");

invalidateEvaluationCommands.add("UPDATE_EDEN_PIVOT_DOMAIN");
...
inverseCommandRegistry.add("UPDATE_EDEN_PIVOT_DOMAIN", identity);

export { PivotEdenCorePlugin, PivotUIGlobalFilterPlugin };
