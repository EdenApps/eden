...
import { helpers, registries, EvaluationError } from "@eden/o-spreadsheet";
...
functionRegistry.add("EDEN.LIST", EDEN_LIST);
functionRegistry.add("EDEN.LIST.HEADER", EDEN_LIST_HEADER);
