...
export class GlobalFiltersUIPlugin extends EdenUIPlugin {
    ...
    constructor(config) {
        ...
        this.edenDataProvider = config.custom.edenDataProvider;
        /**
        ...
        switch (filter.type) {
            ...
            case "relation":
                ...
                if (!this.recordsDisplayName[filter.id]) {
                    ...
                    this.edenDataProvider.notifyWhenPromiseResolves(promise);
                    return [[{ value: "" }]];
                }
