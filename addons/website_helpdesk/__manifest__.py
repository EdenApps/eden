...
################################################################################
{
    ...
    'description': """Website Helpdesk, Eden Helpdesk, Helpdesk, Helpdesk Management, Helpdesk Ticket, Odoo18 Helpdesk, Website Ticket, Support Ticket, Odoo18""",
    ...
    'assets': {
        'web.assets_frontend': [
            '/website_helpdesk/static/src/js/ticket_details.js',
            '/website_helpdesk/static/src/js/portal_search.js',
            '/website_helpdesk/static/src/js/multiple_product_choose.js',
        ]
    },
