...
class WebsiteDesk(http.Controller):
    ...
    def helpdesk_ticket(self, **kwargs):
        ...
        return request.render('website_helpdesk.ticket_form', values)
    ...
    def rating(self, ticket_id):
        ...
        return request.render('website_helpdesk.rating_form', data)
    ...
    def rating_backend(self, ticket_id, **post):
        ...
        return request.render('website_helpdesk.rating_thanks')
