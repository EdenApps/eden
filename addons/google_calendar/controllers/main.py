...
from eden.addons.calendar.controllers.main import CalendarController
from eden.addons.google_account.models.google_service import _get_client_secret
...
class GoogleCalendarController(CalendarController):
    ...
    def google_calendar_sync_data(self, model, **kw):
        """ This route/function is called when we want to synchronize Eden
            ...
            The dictionary may contains an url, to allow Eden Client to redirect user on
        ...
        if model == 'calendar.event':
            ...
            # Checking that user have already accepted Eden to access his calendar !
