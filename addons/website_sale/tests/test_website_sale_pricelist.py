...
from eden.addons.base.tests.common import HttpCaseWithUserPortal, TransactionCaseWithUserDemo
...
class TestWebsitePriceList(WebsiteSaleCommon):
    ...
    def setUp(self):
        super().setUp()
        patcher = patch('eden.addons.website_sale.models.website.Website.get_pricelist_available', wraps=self._get_pricelist_available)
...
def simulate_frontend_context(self, website_id=1):
    ...
    patcher = patch('eden.addons.website.models.ir_http.get_request_website', wraps=get_request_website)
    self.startPatcher(patcher)
...
class TestWebsitePriceListAvailableGeoIP(TestWebsitePriceListAvailable):
    ...
    def test_get_pricelist_available_geoip(self):
        ...
        with patch('eden.addons.website_sale.models.website.Website._get_geoip_country_code', return_value=self.BE.code):
            pls = self.website.get_pricelist_available()
    ...
    def test_get_pricelist_available_geoip4(self):
        ...
        with patch('eden.addons.website_sale.models.website.Website._get_geoip_country_code', return_value=self.BE.code), \
            patch('eden.addons.website_sale.models.website.Website._get_cached_pricelist_id', return_value=current_pl.id):
            pls = self.website.get_pricelist_available(show_visible=True)
    ...
    def test_get_pricelist_available_geoip5(self):
        ...
        with patch('eden.addons.website_sale.models.website.Website._get_geoip_country_code', return_value=self.US.code):
    ...
    def test_get_pricelist_available_geoip6(self):
        ...
        with patch(
            'eden.addons.website_sale.models.website.Website._get_geoip_country_code',
