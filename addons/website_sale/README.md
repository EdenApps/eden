...
Eden is an <a href="https://www.edencloud.us/app/ecommerce">Open Source eCommerce</a>
...
Eden's unique *'edit inline'* and building blocks approach makes product pages
...
Eden's upselling algorythm allows you to show visitors similar but more
...
Get a clear visibility of your sales funnel. Eden's Google Analytics trackers
are configured by default to track all kind of events related to shopping
carts, call-to-actions, etc.

As Eden marketing tools (mass mailing, campaigns, etc) are also linked with
Google Analytics, you get a complete view of your business.

Target New Markets
------------------

Get your website translated in multiple languages with no effort. Eden proposes
...
SEO tools are ready to use, with no configuration required. Eden suggests
...
Create new landing pages easily with the Eden inline editing feature. Send
...
Benefit from the power of Eden, in your online store: a powerfull tax engine,
...
Everything is integrated with Eden. No pain, real time.
