...
import eden
from eden.modules.registry import Registry, DummyRLock
from eden.tests.common import BaseCase, tagged, get_db_name
...
class TestAuthLDAP(BaseCase):
    ...
    def test_auth_ldap(self):
            ...
            return [
                {
                    ...
                    "ldap_binddn": "cn=admin,dc=eden,dc=com",
                    "ldap_password": "admin",
                    "ldap_filter": "cn=%s",
                    "ldap_base": "dc=eden,dc=com",
                    "user": (6, "Marc Demo"),
                    "create_user": True,
                    "ldap_tls": False,
                }
        ...
        def _authenticate(*args, **kwargs):
            return (
                "cn=test_ldap_user,dc=eden,dc=com",
                {
                    "sn": [b"test_ldap_user"],
                    "cn": [b"test_ldap_user"],
        ...
        session = eden.http.root.session_store.get(res.cookies["session_id"])
        self.assertEqual(
