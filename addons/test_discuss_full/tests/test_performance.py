...
from eden.tests.common import users, tagged, HttpCase, warmup
    ...
    def _get_init_store_data_result(self):
        ...
        return {
            ...
            "Store": {
                ...
                "edenbot": {"id": self.user_root.partner_id.id, "type": "partner"},
