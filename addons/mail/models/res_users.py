...
from eden import _, api, Command, fields, models, modules, tools
        ...
        store.add(
            {
                ...
                # sudo: res.partner - exposing EdenBot data is considered acceptable
                "edenbot": Store.one(self.env.ref("base.partner_root").sudo()),
            }
        )
