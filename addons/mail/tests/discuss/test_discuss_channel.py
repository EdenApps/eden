...
from eden.addons.mail.models.discuss.discuss_channel import channel_avatar, group_avatar
...
from eden.tests import HttpCase, tagged, users
from eden.tools import html_escape, mute_logger
