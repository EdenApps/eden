...
class TestLinkPreview(MailCommon):
    ...
    def test_link_preview_ignore_internal_link(self):
        ...
        with patch.object(requests.Session, "get", self._patch_with_og_properties), patch.object(
            ...
            urls = [
                ("http://localhost:8042/", "http://localhost:8042/eden", 0),
                ("http://localhost:8042/", "http://localhost:8042/eden/test", 0),
                ("http://localhost:8042/", "http://localhost:8042/web/test", 0),
                ("http://localhost:8042/", "http://localhost:8042/", 1),
                ("http://localhost:8042/", "http://localhost:8042/eden-experience", 1),
                ("http://localhost:8042/", "http://localhost:8042/chat/5/bFtIfYHRco", 0),
