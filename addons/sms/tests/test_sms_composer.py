...
from eden.addons.sms.models.mail_thread import MailThread
from eden.addons.sms.tests.common import SMSCommon, SMSCase
...
class TestSMSComposerComment(SMSCommon, SMSCase):
    ...
    def test_message_post_sms_vs_notification(self):
        ...
        cases = [
            (
                'Hello there, check this awesome <b>app</b> I found:<br/>https://edencloud.us',  # not a `a` link in source
                '<p>Hello there, check this awesome &lt;b&gt;app&lt;/b&gt; I found:&lt;br/&gt;<a href="https://edencloud.us" target="_blank" rel="noreferrer noopener">https://edencloud.us</a></p>',
                'Hello there, check this awesome <b>app</b> I found:<br/>https://edencloud.us'
            ), (
                'Hello there, check this awesome <b>app</b> I found:<br/><a href="https://edencloud.us">Here</a>',   # a link
                '<p>Hello there, check this awesome &lt;b&gt;app&lt;/b&gt; I found:&lt;br/&gt;&lt;a href="<a href="https://edencloud.us" target="_blank" rel="noreferrer noopener">https://edencloud.us</a>"&gt;Here&lt;/a&gt;</p>',
                'Hello there, check this awesome <b>app</b> I found:<br/><a href="https://edencloud.us">Here</a>'  # keep all information
            )
        ]
    ...
    def test_message_sms_body_sms_vs_notification(self):
        ...
        cases = [
            (
                ...
                '<a href="https://edencloud.us" target="_blank" rel="noreferrer noopener">https://edencloud.us</a></p>',
            ), (
