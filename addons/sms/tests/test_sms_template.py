...
class TestSmsTemplateAccessRights(TransactionCase):
    ...
    @users('user_system')
    @mute_logger('eden.models.unlink', 'eden.addons.base.models.ir_model')
...
class TestSMSTemplateReset(TransactionCase):
    ...
    def test_sms_template_reset(self):
        ...
        self.assertEqual(sms_template.body.strip(), Markup('<div>Hello Eden</div>'))
