...
import { Component, markup, useEffect, useRef, useState } from "@eden/owl";
...
options.registry.OptionsTab = options.registry.WebsiteLevelColor.extend({
    ...
    async updateUI() {
        ...
        // If the gray palette has been generated by Eden standard option,
        ...
        // same hue by the Eden editor, there might be rounding errors
                ...
                this.trigger_up('menu_dialog', {
                    ...
                    save: (name, url) => {
                        ...
                        return this.orm.call(
                            ...
                            widget.wysiwyg.edenEditor.observerUnactive();
                            widget.$target.attr('href', url);
                            $menu.text(name);
                            widget.wysiwyg.edenEditor.observerActive();
                        });
                    },
                });
                widget.popover.hide();
...
options.registry.TextHighlight = options.Class.extend({
    ...
    */
    ...
    _autoAdaptHighlights() {
        this.trigger_up("snippet_edition_request", { exec: async () =>
            await this._refreshPublicWidgets($(this.options.wysiwyg.edenEditor.editable))
        });
    },
