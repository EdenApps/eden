...
from eden.addons.website.tools import MockRequest, create_image_attachment
...
class TestSnippets(HttpCase):
    ...
    def test_03_snippets_all_drag_and_drop(self):
        ...
        self.start_tour(f"/eden/action-website.website_preview?{path}", "snippets_all_drag_and_drop", login='admin', timeout=600)
    ...
    def test_05_social_media(self):
        ...
        self.assertEqual(
            ...
            'https://instagram.com/eden.official/',
