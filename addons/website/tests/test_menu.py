...
class TestMenu(common.TransactionCase):
    ...
    def test_06_menu_active(self):
        ...
        def test_full_case(a_menu):
            ...
            """
            url = a_menu.url
            self.request_url_mock = 'http://localhost:8042' + url
        ...
        self.request_url_mock = 'http://localhost:8042/'
        with MockRequest(self.env, website=website_1), \
             patch('eden.addons.website.models.website_menu.url_parse', new=url_parse_mock):
            ...
            self.request_url_mock = 'http://localhost:8042/contactus'
