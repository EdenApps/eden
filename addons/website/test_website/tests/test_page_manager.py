...
class TestWebsitePageManager(eden.tests.HttpCase):
    def test_page_manager_test_model(self):
        ...
        self.start_tour('/eden/action-test_website.action_test_model_multi_website', 'test_website_page_manager', login="admin")
        ...
        self.start_tour('/eden/action-test_website.action_test_model_multi_website_js_class_bug', 'test_website_page_manager_js_class_bug', login="admin")
        self.start_tour('/eden/action-test_website.action_test_model', 'test_website_page_manager_no_website_id', login="admin")
