...
import { EdenEditor, parseHTML, setSelection, insertCharsAt } from '../../src/EdenEditor.js';
import {
...
const testMultiEditor = async spec => {
    ...
    for (const clientInfo of clientInfosList) {
        ...
        let nextId = 1;
        EdenEditor.prototype._generateId = () => 'fake_id_' + nextId++;

        clientInfo.editor = new EdenEditor(clientInfo.editable, Object.assign({
            toSanitize: false,
    ...
    EdenEditor.prototype._generateId = () => 'fake_concurent_id_' + concurentNextId++;
