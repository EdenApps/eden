...
import { EdenEditor } from '../src/EdenEditor.js';
...
export async function testEditor(Editor = EdenEditor, spec, options = {}) {
    hasMobileTest = false;
...
export const pasteEdenEditorHtml = async (editor, html) => pasteData(editor, html, 'text/eden-editor');
...
export class BasicEditor extends EdenEditor {}
