...
from eden.tools.misc import hmac as hmac_tool
...
class PaymentCommon(BaseCommon):
    ...
    def setUp(self):
        ...
        if self.account_payment_installed and self.enable_post_process_patcher:
            ...
            self.post_process_patcher = patch(
                'eden.addons.account_payment.models.payment_transaction.PaymentTransaction._post_process',
            )
    ...
    def _generate_test_access_token(self, *values):
        ...
        environment of eden.http.request.
