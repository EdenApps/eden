...
from eden.tests import Form, HttpCase, tagged, warmup
from eden.addons.mail.tests.common import MailCase
from eden.addons.marketing_card.controllers.marketing_card import SOCIAL_NETWORK_USER_AGENTS
...
class TestMarketingCardRender(MarketingCardCommon):
    ...
    def test_campaign(self):
        ...
        with patch('eden.addons.marketing_card.models.card_campaign.CardCampaign._get_model_selection',
