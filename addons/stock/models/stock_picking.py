...
from eden.addons.stock.models.stock_move import PROCUREMENT_PRIORITIES
from eden.addons.web.controllers.utils import clean_action
from eden.exceptions import UserError, ValidationError
from eden.osv import expression
from eden.tools import format_datetime, format_date, format_list, groupby, SQL
...
class PickingType(models.Model):
    ...
    auto_show_reception_report = fields.Boolean(
        ...
        help="If this checkbox is ticked, Eden will automatically show the reception report (if there are moves to allocate to) when validating.")
    auto_print_delivery_slip = fields.Boolean(
        "Auto Print Delivery Slip",
        help="If this checkbox is ticked, Eden will automatically print the delivery slip of a picking when it is validated.")
    auto_print_return_slip = fields.Boolean(
        "Auto Print Return Slip",
        help="If this checkbox is ticked, Eden will automatically print the return slip of a picking when it is validated.")

    auto_print_product_labels = fields.Boolean(
        "Auto Print Product Labels",
        help="If this checkbox is ticked, Eden will automatically print the product labels of a picking when it is validated.")
    ...
    auto_print_lot_labels = fields.Boolean(
        ...
        help="If this checkbox is ticked, Eden will automatically print the lot/SN labels of a picking when it is validated.")
    ...
    auto_print_reception_report = fields.Boolean(
        ...
        help="If this checkbox is ticked, Eden will automatically print the reception report of a picking when it is validated and has assigned moves.")
    auto_print_reception_report_labels = fields.Boolean(
        "Auto Print Reception Report Labels",
        help="If this checkbox is ticked, Eden will automatically print the reception report labels of a picking when it is validated.")
    auto_print_packages = fields.Boolean(
        "Auto Print Packages",
        help="If this checkbox is ticked, Eden will automatically print the packages and their contents of a picking when it is validated.")

    auto_print_package_label = fields.Boolean(
        "Auto Print Package Label",
        help="If this checkbox is ticked, Eden will automatically print the package label when \"Put in Pack\" button is used.")
