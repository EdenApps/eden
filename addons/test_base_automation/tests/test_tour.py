...
class BaseAutomationTestUi(HttpCase):
    ...
    def test_01_base_automation_tour(self):
        ...
        self.start_tour("/eden/action-base_automation.base_automation_act?debug=tests", "test_base_automation", login="admin")
    ...
    def test_base_automation_on_tag_added(self):
        ...
        self.start_tour("/eden/action-base_automation.base_automation_act?debug=tests", "test_base_automation_on_tag_added", login="admin")
    ...
    def test_open_automation_from_grouped_kanban(self):
        ...
        self.start_tour(f"/eden/action-{test_action.id}?debug=0", "test_open_automation_from_grouped_kanban", login="admin")
    ...
    def test_kanban_automation_view_stage_trigger(self):
        ...
        self.start_tour(
            "/eden/action-base_automation.base_automation_act",
    ...
    def test_form_view(self):
        ...
        self.start_tour(
            (
                f"/eden/action-base_automation.base_automation_act/{automation.id}?debug=0"
            ),
    ...
    def test_form_view_model_id(self):
        self.start_tour(
            (
                "/eden/action-base_automation.base_automation_act/new?view_type='form'&amp;debug=0)"
            ),
    ...
    def test_on_change_rule_creation(self):
        ...
        self.start_tour("/eden/action-base_automation.base_automation_act", 'base_automation.on_change_rule_creation', login="admin")
