...
from eden.modules.module import get_module_root, MANIFEST_NAMES
from eden.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """ Quickly start the eden server with default options """
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            eden.tools.config['init']['base'] = True
