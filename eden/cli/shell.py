...
class Shell(Command):
    """Start eden in an interactive shell"""
    ...
    def init(self, args):
        ...
        eden.cli.server.report_configuration()
        eden.service.server.start(preload=[], stop=True)
    ...
    def shell(self, dbname):
        ...
        if dbname:
            ...
            with registry.cursor() as cr:
                ...
                ctx = eden.api.Environment(cr, uid, {})['res.users'].context_get()
                env = eden.api.Environment(cr, uid, ctx)
                local_vars['env'] = env
