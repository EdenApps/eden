...
import eden
from eden import api, http
from eden.addons import __path__ as ADDONS_PATH
from eden.addons.base.models.assetsbundle import AssetsBundle, XMLAssetError, ANY_UNIQUE
from eden.addons.base.models.ir_asset import AssetPaths
from eden.addons.base.models.ir_attachment import IrAttachment
...
from eden.tools import mute_logger, func
...
class TestAddonPaths(TransactionCase):
    def test_operations(self):
        ...
        asset_paths.append([
            ('/home/user/eden/addons/web/a', '/web/a', 1),
            ('/home/user/eden/addons/web/c', '/web/c', 1),
            ('/home/user/eden/addons/web/d', '/web/d', 1),
        ], 'bundle1')
        self.assertEqual(asset_paths.list, [
            ('/home/user/eden/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/eden/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/eden/addons/web/d', '/web/d', 'bundle1', 1),
        ])

        # append with a duplicate of 'c'
        asset_paths.append([
            ('/home/user/eden/addons/web/c', '/web/c', 1),
            ('/home/user/eden/addons/web/f', '/web/f', 1),
        ], 'bundle2')
        self.assertEqual(asset_paths.list, [
            ('/home/user/eden/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/eden/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/eden/addons/web/d', '/web/d', 'bundle1', 1),
            ('/home/user/eden/addons/web/f', '/web/f', 'bundle2', 1),
        ])

        # insert with a duplicate of 'c' after 'c'
        asset_paths.insert([
            ('/home/user/eden/addons/web/c', '/web/c', 1),
            ('/home/user/eden/addons/web/e', '/web/e', 1),
        ], 'bundle3', 3)
        self.assertEqual(asset_paths.list, [
            ('/home/user/eden/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/eden/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/eden/addons/web/d', '/web/d', 'bundle1', 1),
            ('/home/user/eden/addons/web/e', '/web/e', 'bundle3', 1),
            ('/home/user/eden/addons/web/f', '/web/f', 'bundle2', 1),
        ])

        # insert with a duplicate of 'd' before 'd'
        asset_paths.insert([
            ('/home/user/eden/addons/web/b', '/web/b', 1),
            ('/home/user/eden/addons/web/d', '/web/d', 1),
        ], 'bundle4', 1)
        self.assertEqual(asset_paths.list, [

            ('/home/user/eden/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/eden/addons/web/b', '/web/b', 'bundle4', 1),
            ('/home/user/eden/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/eden/addons/web/d', '/web/d', 'bundle1', 1),
            ('/home/user/eden/addons/web/e', '/web/e', 'bundle3', 1),
            ('/home/user/eden/addons/web/f', '/web/f', 'bundle2', 1),
        ...
        asset_paths.remove([
            ('/home/user/eden/addons/web/c', '/web/c', 1),
            ('/home/user/eden/addons/web/d', '/web/d', 1),
            ('/home/user/eden/addons/web/g', '/web/g', 1),
        ], 'bundle5')
        self.assertEqual(asset_paths.list, [
            ('/home/user/eden/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/eden/addons/web/b', '/web/b', 'bundle4', 1),
...
class AddonManifestPatched(TransactionCase):
    def setUp(self):
        ...
        self.patch(eden.modules.module, '_get_manifest_cached', Mock(side_effect=lambda module: self.manifests.get(module, {})))
...
class TestJavascriptAssetsBundle(FileTouchable):
    ...
    def test_15_rtl_invalid_css_generation(self):
        ...
        with mute_logger('eden.addons.base.models.assetsbundle'):
            self.bundle.css()
...
<html>
    <head>
        ...
        <script type="text/javascript" src="{links[5]}" onerror="__edenAssetError=1"></script>
    </head>
    <body>
    </body>
</html>"""))
...
<html>
    <head>
        ...
        <script type="text/javascript" src="http://test.external.link/javascript1.js"></script>
        <script type="text/javascript" src="http://test.external.link/javascript2.js"></script>
        <script type="text/javascript" src="/web/assets/debug/test_assetsbundle.bundle4.js" onerror="__edenAssetError=1"></script>
    </head>
    <body>
    </body>
</html>"""))
...
class TestAssetsManifest(AddonManifestPatched):
    ...
    @mute_logger('eden.addons.base.models.ir_asset')
    def test_31(self):
...
class TestErrorManagement(HttpCase):
    ...
    def test_assets_bundle_css_error_backend(self):
        ...
        with mute_logger('eden.addons.base.models.assetsbundle'):
            self.start_tour('/eden', 'css_error_tour', login='admin')
