...
import { Deferred, animationFrame, tick } from "@eden/hoot-mock";
import {
    Command,
    getService,
    onRpc,
...
test("Show recipient list when there is more than 5 followers.", async () => {
    ...
    const partnerIds = pyEnv["res.partner"].create([
        { name: "test name 1", email: "test1@eden.com" },
        { name: "test name 2", email: "test2@eden.com" },
        { name: "test name 3", email: "test3@eden.com" },
        { name: "test name 4", email: "test4@eden.com" },
        { name: "test name 5", email: "test5@eden.com" },
        { name: "test name 6", email: "test6@eden.com" },
    ]);
    ...
    await contains("li", { text: "test1@eden.com" });
    await contains("li", { text: "test2@eden.com" });
    await contains("li", { text: "test3@eden.com" });
    await contains("li", { text: "test4@eden.com" });
    await contains("li", { text: "test5@eden.com" });
    await contains("li", { text: "test6@eden.com" });
...
test("Show 'No recipient found.' with 0 followers.", async () => {
    const pyEnv = await startServer();
    const partnerId = pyEnv["res.partner"].create({ name: "test name 1", email: "test1@eden.com" });
    await start();
