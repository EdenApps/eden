...
from eden import _, api, fields, models, Command, tools
from eden.exceptions import UserError, ValidationError
from eden.osv import expression
from eden.tools.mail import is_html_empty, email_normalize, email_split_and_format
...
class MailComposer(models.TransientModel):
    ...
    def _evaluate_res_domain(self):
        ...
        :return: an Eden domain (list of leaves) """
        self.ensure_one()
