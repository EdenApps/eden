...
from eden.tests.common import JsonRpcException, new_test_user, tagged
...
class TestTranslationController(HttpCaseWithUserDemo):
    ...
    def test_access_right(self):
        ...
        with self.assertRaises(JsonRpcException, msg="eden.exceptions.AccessError"), mute_logger("eden.http"):
            self._mock_translation_request({"message_id": self.message.id})
