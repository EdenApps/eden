...
from eden.tests.common import new_test_user, Like
from eden.tools import mute_logger
from eden.addons.test_http.utils import HtmlTokenizer
...
class TestHttpModels(TestHttpBase):
    ...
    def test_models5_stargate_setname_readonly(self):
        ...
        with self.assertLogs('eden.http', 'WARNING') as capture_http,\
             self.assertLogs('eden.sql_db', 'WARNING') as capture_sql_db:
