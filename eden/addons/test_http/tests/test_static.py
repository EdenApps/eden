...
import eden
from eden.tests import new_test_user, tagged, RecordCapturer
from eden.tools import config, file_open, image_process
from eden.tools.misc import submap
...
class TestHttpStaticLogo(TestHttpStaticCommon):
    ...
    def setUpClass(cls):
        ...
        super_user = cls.env['res.users'].browse([eden.SUPERUSER_ID])
