...
from eden.modules import get_modules, get_module_path
...
class TestPyLint(TransactionCase):
    ...
    def test_pylint(self):
        ...
        options = [
            ...
            '--load-plugins=pylint.extensions.bad_builtin,_eden_checker_sql_injection,_eden_checker_gettext,_eden_checker_unlink_override',
