...
from eden.modules.module import _DEFAULT_MANIFEST, module_manifest, get_module_path
from eden.tests import BaseCase
...
class ManifestLinter(BaseCase):
    ...
    def _load_manifest(self, module):
        """Do not rely on eden/modules/module -> load_manifest
