...
import eden.tests
from eden.tests.common import HttpCase, new_test_user
...
class TestController(HttpCase):
    ...
    <svg viewBox="0 0 400 400">
      ...
      <rect x="20" y="20" width="300" height="300" style="fill:#1C9300;" />
      ...
      <rect x="80" y="80" width="300" height="300" style="fill:#383E45;" />
            ...
            palette = 'c1=%233AADAA&c2=%231C9300&&c3=%23F6F6F6&&c4=%23FFFFFF&&c5=%23383E45'
    ...
    def test_05_internal_link_preview(self):
        ...
        response_without_preview_name = self.url_open(
            ...
            data=json_safe.dumps({
                "params": {
                    "preview_url": f"/eden/users/{self.portal_user.id}",
                }
            }),
        ...
        response_wrong_action = self.url_open(
            ...
            data=json_safe.dumps({
                "params": {
                    "preview_url": "/eden/actionInvalid/1",
                }
            }),
            headers=self.headers
        )
        ...
        # Attempt to retrieve metadata for path format `eden/<model>/<record_id>`
        response_model_record = self.url_open(
            '/html_editor/link_preview_internal',
            data=json_safe.dumps({
                "params": {
                    "preview_url": f"/eden/res.users/{self.portal_user.id}",
                }
            }),
            headers=self.headers
        )
        ...
        response_abstract_model = self.url_open(
            ...
            data=json_safe.dumps({
                "params": {
                    "preview_url": "/eden/mail.thread/1",
                }
            }),
            headers=self.headers
        )
