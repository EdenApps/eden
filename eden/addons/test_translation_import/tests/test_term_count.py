...
from eden.tools.misc import file_open, mute_logger, file_path
from eden.tools.translate import TranslationModuleReader, TranslationRecordReader, code_translations, CodeTranslations, PYTHON_TRANSLATION_COMMENT, JAVASCRIPT_TRANSLATION_COMMENT, TranslationFileReader
from eden import Command
from eden.addons.base.models.ir_fields import BOOLEAN_TRANSLATIONS
...
class TestImport(common.TransactionCase):
    ...
    def test_import_from_po_file(self):
        ...
        with mute_logger('eden.addons.base.models.res_lang'):
...
class TestTranslationFlow(common.TransactionCase):
    ...
    def test_export_spreadsheet_new_dataset(self):
        ...
        self.assertEqual(set(terms), {
            ...
            'Scorecard title',
            'Opportunities',
            'Eden Chart horizontal axis title',
            'Eden Chart vertical axis title'
        })
