...
from eden.tests import Form, TransactionCase, users
from eden.tools import mute_logger, get_lang
...
class PropertiesCase(TestPropertiesMixin):
    ...
    @mute_logger('eden.models.unlink', 'eden.fields')
    ...
    @users('test')
    @mute_logger('eden.addons.base.models.ir_rule', 'eden.fields')
    ...
    def test_properties_field_security(self):
        ...
        self.env.invalidate_all()
        with patch('eden.addons.test_new_api.models.test_new_api.MultiTag.check_access', _mocked_check_access):
            values = message.read(['attributes'])[0]['attributes'][0]
        ...
        self.env.invalidate_all()
        with patch('eden.addons.test_new_api.models.test_new_api.Discussion.check_access', _mocked_check_access):
            values = message.read(['attributes'])[0]['attributes'][0]
        self.assertEqual(values['value'], (tag.id, 'Test Tag'))
...
class PropertiesGroupByCase(TestPropertiesMixin):
    ...
    @mute_logger('eden.fields', 'eden.models.unlink')
