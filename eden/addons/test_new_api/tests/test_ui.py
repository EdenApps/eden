...
class TestUi(HttpCaseWithUserDemo):
    ...
    def test_01_admin_widget_x2many(self):
        ...
        self.start_tour("/eden/action-test_new_api.action_discussions",
            'widget_x2many', login="admin", timeout=120)


@eden.tests.tagged('-at_install', 'post_install')
class TestUiTranslation(eden.tests.HttpCase):

    @mute_logger('eden.sql_db', 'eden.http')
    def test_01_sql_constraints(self):
        ...
        self.start_tour("/eden/action-test_new_api.action_categories",
