...
class m(models.Model):
    ...
    def generate_redirect_warning(self):
        ...
        raise eden.exceptions.RedirectWarning('description', action.id, 'Go to the redirection')

    def generate_access_denied(self):
        raise eden.exceptions.AccessDenied()

    def generate_access_error(self):
        raise eden.exceptions.AccessError('description')
    ...
    def generate_user_error(self):
        raise eden.exceptions.UserError('description')

    def generate_missing_error(self):
        raise eden.exceptions.MissingError('description')

    def generate_validation_error(self):
        raise eden.exceptions.ValidationError('description')
