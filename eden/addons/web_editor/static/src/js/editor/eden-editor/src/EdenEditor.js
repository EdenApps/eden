...
export class EdenEditor extends EventTarget {
    constructor(editable, options = {}) {
        ...
        this.options = defaultOptions(
            {
                ...
                // `convertNumericToUnit` as eden-editor utils to avoid this
        ...
        this.editable.classList.add("eden-editor-editable");
    ...
    _onClipboardCopy(clipboardEvent) {
        ...
        const edenHtml = dataHtmlElement.innerHTML.replace(/\uFEFF/g, "");
        const edenText = selection.toString().replace(/\uFEFF/g, "");
        clipboardEvent.clipboardData.setData('text/plain', edenText);
        clipboardEvent.clipboardData.setData('text/html', edenHtml);
        clipboardEvent.clipboardData.setData('text/eden-editor', edenHtml);
    }
    /**
     * @private
     */
    ...
    isSelectionInBlockRoot() {
        ...
        while (
            ...
            !currentNode.classList.contains('eden-editor-editable') &&
    ...
    _onPaste(ev) {
        ...
        const edenEditorHtml = ev.clipboardData.getData('text/eden-editor');
