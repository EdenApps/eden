...
import { Component, useRef, useSubEnv } from "@eden/owl";
 ...
 * It uses a feature to automatically create links to other eden pages if the selector [res-id][res-model][view-type]
 * is detected.
 */
