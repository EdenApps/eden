    ...
    var QWebHighlightRules = function () {
        ...
        this.$rules = Object.assign({},
            xmlRules,
            {
                ...
                attributes_eden: [{
                    token: ["entity.other.attribute-name.xml.eden", "keyword.operator.attribute-equals.xml", "text", "string.attribute-value.xml.start", "string.attribute-value.xml.code", "string.attribute-value.xml.end"],
