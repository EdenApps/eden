...
QWeb is the primary templating engine used by Eden. It is an XML templating
...
<https://www.edencloud.us/documentation/master/developer/reference/frontend/qweb.html>`
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
**Values**: name of the allowed eden user group, or preceded by ``!`` for
prohibited groups

The generated code uses ``has_group`` Eden method from ``res.users`` model.
...
from eden import api, models, tools
from eden.modules import registry
from eden.tools import config, safe_eval, pycompat
from eden.tools.constants import SUPPORTED_DEBUGGER, EXTERNAL_ASSET
from eden.tools.safe_eval import assert_valid_codeobj, _BUILTINS, to_opcodes, _EXPR_OPCODES, _BLACKLIST
from eden.tools.json import scriptsafe
from eden.tools.lru import LRU
from eden.tools.misc import str2bool
from eden.tools.image import image_data_uri, FILETYPE_BASE64_MAGICWORD
from eden.http import request
from eden.tools.profiler import QwebTracker
from eden.exceptions import UserError, AccessDenied, AccessError, MissingError, ValidationError

from eden.addons.base.models.assetsbundle import AssetsBundle
from eden.tools.constants import SCRIPT_EXTENSIONS, STYLE_EXTENSIONS, TEMPLATE_EXTENSIONS
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _debug_trace(self, debugger, values):
        ...
        if not debugger:
            ...
            warnings.warn(
                ...
                "since Eden 17.0, keep the value empty and configure the "
    ...
    def _link_to_node(self, path, defer_load=False, lazy_load=False, media=None):
        ...
        if is_js:
            ...
            if is_asset_bundle:
                attributes['onerror'] = "__edenAssetError=1"
