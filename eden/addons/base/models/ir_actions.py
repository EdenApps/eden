...
from eden.exceptions import MissingError, ValidationError, AccessError, UserError
from eden.tools import frozendict
from eden.tools.safe_eval import safe_eval, test_python_expr
...
class IrActionsServer(models.Model):
    ...
    Since Eden 8.0 a button 'Create Menu Action' button is available on the
...
# To return an action, assign: action = {...}\n\n\n\n"""
    ...
    def _get_eval_context(self, action=None):
        ...
        eval_context.update({
            ...
            'model': model,
            # Exceptions
            'UserError': eden.exceptions.UserError,
            # record
            'record': record,
            'records': records,
            # helpers
