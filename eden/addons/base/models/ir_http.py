...
import eden
from eden import api, http, models, tools, SUPERUSER_ID
from eden.exceptions import AccessDenied
from eden.http import request, Response, ROUTING_KEYS
from eden.modules.registry import Registry
from eden.service import security
from eden.tools.json import json_default
from eden.tools.misc import get_lang, submap
from eden.tools.translate import code_translations

_logger = logging.getLogger(__name__)

# see also mimetypes module: https://docs.python.org/3/library/mimetypes.html and eden.tools.mimetypes
...
class IrHttp(models.AbstractModel):
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        for key, val in list(args.items()):
            ...
            try:
            ...
            except (eden.exceptions.AccessError, eden.exceptions.MissingError) as e:
                ...
                if isinstance(e, eden.exceptions.MissingError):
    ...
    def routing_map(self, key=None):
        ...
        installed = registry._init_modules.union(eden.conf.server_wide_modules)
    ...
    def _gc_sessions(self):
        if os.getenv("EDEN_SKIP_GC_SESSIONS"):
            return
