...
from eden import api, fields, models, tools, Command
from eden.exceptions import AccessError, UserError, ValidationError
from eden.osv import expression
from eden.tools import format_list, lazy_property, sql, unique, OrderedSet, SQL
from eden.tools.safe_eval import safe_eval, datetime, dateutil, time
...
class IrModel(models.Model):
    ...
    def unlink(self):
        ...
        # reload is done independently in eden.modules.loading.
...
class IrModelConstraint(models.Model):
    """
    This model tracks PostgreSQL foreign keys and constraints used by Eden
    models.
    """
...
class IrModelRelation(models.Model):
    """
    This model tracks PostgreSQL tables used to implement Eden many2many
    relations.
    """
...
class IrModelData(models.Model):
    """Holds external identifier keys for records in the database.
       This has two main uses:
           ...
           * allows tracking the origin of data installed by Eden
