...
from eden.exceptions import MissingError, UserError
from eden.http import Stream, request
from eden.tools import file_open, replace_exceptions
from eden.tools.image import image_process, image_guess_size_from_field_name
from eden.tools.mimetypes import guess_mimetype, get_extension
from eden.tools.misc import verify_limited_field_access_token
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:eden.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~eden.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`eden.tools.image.image_process`.
