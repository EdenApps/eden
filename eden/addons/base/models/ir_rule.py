...
from eden.tools import config, SQL
...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - eden/addons/test_access_rights/tests/test_feedback.py
        # - eden/addons/test_access_rights/tests/test_ir_rules.py
        # - eden/addons/base/tests/test_orm.py (/home/dle/src/eden/master-nochange-fp/eden/addons/base/tests/test_orm.py)
        self.env.flush_all()
        self.env.registry.clear_cache()
        return res
    ...
    def _make_access_error(self, operation, records):
        ...
        if company_related:
            ...
            if suggested_companies and len(suggested_companies) != 1:
                resolution_info += _('\n\nNote: this might be a multi-company issue. Switching company may help - in Eden, not in real life!')
