...
import eden
from eden import api, fields, models, modules, tools, _
from eden.addons.base.models.ir_model import MODULE_UNINSTALL_FLAG
from eden.exceptions import AccessDenied, UserError, ValidationError
from eden.osv import expression
from eden.tools.parse_version import parse_version
from eden.tools.misc import topological_sort, get_flag
from eden.tools.translate import TranslationImporter, get_po_paths
from eden.http import request
from eden.modules import get_module_path
...
class Module(models.Model):
                ...
                with tools.file_open(path, 'rb') as desc_file:
                    ...
                    if doc.startswith(XML_DECLARATION):
                        warnings.warn(
                            ...
                            f"deprecated since Eden 17, {module.name} can just "
                        ...
                        try:
                            ...
                            warnings.warn(
                                ...
                                f"since Eden 17 ({module.name}'s description "
                                f"is not utf-8)",
                                category=DeprecationWarning,
                            )
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', 'Eden Enterprise Edition License v1.0'),
        ('OPL-1', 'Eden Proprietary License v1.0'),
    ...
    def _button_immediate_function(self, function):
        ...
        try:
            ...
            raise UserError(_("Eden is currently processing a scheduled action.\n"
    ...
    def button_uninstall(self):
        un_installable_modules = set(eden.conf.server_wide_modules) & set(self.mapped('name'))
