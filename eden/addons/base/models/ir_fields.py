...
from eden.tools.translate import _, code_translations, LazyTranslate
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str):
        ...
        callable taking a record-ish (a dictionary representing an eden
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`eden.osv.orm.Model.write` expects.

        :param model: :class:`eden.osv.orm.Model` for the conversion base
        :param fromtype:
    ...
    def to_field(self, model, field, fromtype=str):
        ...
        :type field: :class:`eden.fields.Field`
