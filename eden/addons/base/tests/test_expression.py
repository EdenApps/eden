...
from eden.addons.base.tests.common import SavepointCaseWithUserDemo
from eden.tests.common import BaseCase, TransactionCase
...
class TestExpression(SavepointCaseWithUserDemo, TransactionExpressionCase):
    ...
    def test_10_hierarchy_in_m2m(self):
        ...
        with self.assertLogs('eden.osv.expression'):
    ...
    def test_like_cast(self):
        ...
        with mute_logger('eden.sql_db'), self.assertRaises(psycopg2.Error):
