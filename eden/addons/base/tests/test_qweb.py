...
from eden.addons.base.models.ir_qweb import QWebException, render
from eden.tools import misc, mute_logger
from eden.tools.json import scriptsafe as json_scriptsafe
from eden.exceptions import UserError, ValidationError, MissingError
...
class TestQWebNS(TransactionCase):
    ...
    def test_render_dynamic_xml_with_code_error(self):
        ...
        view1 = self.env['ir.ui.view'].create({
            ...
            'arch': """
                <t t-name="base.dummy">
                    <Invoice xmlns:od="http://edencloud.us/od">
...
class TestQWebBasic(TransactionCase):
    ...
    def test_attf_escaping_2(self):
        ...
        result = """
                <a href="/link/eden/sub">link</a>
                <a href="/link/eden/">link2</a>
            """
        values = {'url': 'eden', 'other': True}
        rendered = self.env['ir.qweb']._render(t.id, values)
        self.assertEqual(rendered.strip(), result.strip())
    ...
    @mute_logger('eden.addons.base.models.ir_qweb') # warning for template not found
