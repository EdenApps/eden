...
from eden.addons.base.models.res_users import is_selection_groups, get_selection_groups, name_selection_groups
from eden.exceptions import UserError, ValidationError
from eden.http import _request_stack
from eden.tests import Form, TransactionCase, new_test_user, tagged, HttpCase, users
...
class TestUsers(TransactionCase):
    ...
    @mute_logger('eden.sql_db', 'eden.addons.base.models.res_users_deletion')
    ...
    def test_context_get_lang(self):
        ...
        request_patch = patch('eden.addons.base.models.res_users.request', request)
