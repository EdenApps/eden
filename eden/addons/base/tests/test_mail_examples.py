...
cite="mid:CAEJSRZvWvud8c6Qp=wfNG6O1+wK3i_jb33qVrF7XyrgPNjnyUA@mail.gmail.com"
      type="cite"><base href="https://www.edencloud.us">
      <div dir="ltr">Yep Dominique that is true, as Postgres was the
        base of all same as Eden and MySQL etc came much later.Â 
        <div><br>
        </div>
    ...
    on this Eden mailinglist, but when you start implying that Postgres
...
<a href="http://localhost:8042#action=login&amp;db=mail_1&amp;token=rHdWcUART5PhEnJRaXjH">http://localhost:8042#action=login&amp;db=mail_1&amp;token=rHdWcUART5PhEnJRaXjH</a></p>
      </div>
    </blockquote>
...
<div><p>Log in our portal at: <a href="http://localhost:8042#action=login&amp;db=mail_1&amp;login=demo">http://localhost:8042#action=login&amp;db=mail_1&amp;login=demo</a></p></div>
</blockquote>
...
<div style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'; COLOR: #000000">
    <div>Hello</div>
    <div>I have just installed Eden 9 and I've got the following error:</div>
    <div>&nbsp;</div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content openerp">
                <div class="modal-header"> 
                    <h4 class="modal-title">Eden Error<span class="o_subtitle text-muted"></span></h4>
                </div>
