...
from eden.sql_db import db_connect, TestCursor
from eden.tests import common
from eden.tests.common import BaseCase, HttpCase
from eden.tools.misc import config
...
class TestTestCursor(common.TransactionCase):
    def setUp(self):
        ...
        self.env = eden.api.Environment(self.cr, eden.SUPERUSER_ID, {})
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('eden.sql_db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:eden.sql_db:Found different un-closed cursor', msg)
