...
from eden.tools import mute_logger, view_validation, safe_eval
from eden.tools.cache import get_cache_key_counter
from eden.addons.base.models import ir_ui_view
...
class ViewCase(TransactionCaseWithUserDemo):
    ...
    def assertInvalid(self, arch, expected_message=None, name='invalid view', inherit_id=False, model='ir.ui.view'):
        with mute_logger('eden.addons.base.models.ir_ui_view'):
    ...
    def assertWarning(self, arch, expected_message=None, name='invalid view', model='ir.ui.view'):
        with self.assertLogs('eden.addons.base.models.ir_ui_view', level="WARNING") as log_catcher:
            self.View.create({
                'name': name,
                'model': model,
                'arch': arch,
