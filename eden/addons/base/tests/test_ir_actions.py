...
class TestServerActions(TestServerActionsBase):
    def test_00_server_action(self):
        with self.assertLogs('eden.addons.base.models.ir_actions.server_action_safe_eval',
                             level='DEBUG') as log_catcher:
            self.test_server_action.run()
            self.assertEqual(log_catcher.output, [
                'DEBUG:eden.addons.base.models.ir_actions.server_action_safe_eval:This is a test debug log',
                'INFO:eden.addons.base.models.ir_actions.server_action_safe_eval:This is a test info log',
                'WARNING:eden.addons.base.models.ir_actions.server_action_safe_eval:This is a test warning log',
                'ERROR:eden.addons.base.models.ir_actions.server_action_safe_eval:This is a test error log',
"""ERROR:eden.addons.base.models.ir_actions.server_action_safe_eval:This is a test exception log
...
ZeroDivisionError: division by zero""" % self.test_server_action.id
    ...
    @mute_logger('eden.addons.base.models.ir_model', 'eden.models')
    ...
    def test_90_webhook(self):
        ...
        with patch.object(requests, 'post', _patched_post), mute_logger('eden.addons.base.models.ir_actions'):
            # first run: 200
            self.action.with_context(self.context).run()
...
class TestCustomFields(TestCommonCustomFields):
    def test_create_custom(self):
        ...
        with self.assertRaises(IntegrityError), mute_logger('eden.sql_db'):
    ...
    @mute_logger('eden.addons.base.models.ir_ui_view')
...
class TestCustomFieldsPostInstall(TestCommonCustomFields):
    def test_add_field_valid(self):
        ...
        with self.assertLogs('eden.addons.base.models.ir_model') as log_catcher:
