...
from eden.tests.common import TransactionCase, RecordCapturer
from eden.tools import mute_logger
from eden.addons.base.models.ir_cron import MIN_FAILURE_COUNT_BEFORE_DEACTIVATION, MIN_DELTA_BEFORE_DEACTIVATION
    ...
    def test_cron_process_job(self):
        ...
        for cb, curr_failures, trigger, call_count, done_count, fail_count, active in CASES:
            with self.subTest(cb=cb, failure=curr_failures), closing(self.cr.savepoint()):
                ...
                try:
                    with mute_logger('eden.addons.base.models.ir_cron'),\
