...
from eden.tests import BaseCase, TransactionCase, tagged, BaseCase
from eden.tests.common import _logger as test_logger
...
class TestRetry(TestRetryCommon):
    """ Check some tests behaviour when EDEN_TEST_FAILURE_RETRIES is set"""
