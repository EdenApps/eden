...
import eden
from eden.tests import TransactionCase
from eden.tools import file_path, file_open, file_open_temporary_directory
from eden.tools.config import conf, configmanager, _get_default_datadir


IS_POSIX = 'workers' in eden.tools.config.options
ROOT_PATH = eden.tools.config.options['root_path'].removesuffix('/eden')
...
class TestConfigManager(TransactionCase):
    ...
    def setUp(self):
        ...
        self.patch(conf, 'addons_paths', eden.conf.addons_paths)
        self.patch(conf, 'server_wide_modules', eden.conf.server_wide_modules)
    ...
    def test_01_default_config(self):
        ...
        default_values = {
            ...
            'import_partial': '',
            'pidfile': '',
            'addons_path': f'{ROOT_PATH}/eden/addons,{ROOT_PATH}/addons',
            'upgrade_path': '',
    ...
    def test_02_config_file(self):
        values = {
            ...
            'reportgz': True,
            'root_path': f'{ROOT_PATH}/eden',  # blacklist for save, ignored from the config file
    ...
    def test_04_eden16_config_file(self):
        # test that loading the Eden 16.0 generated default config works
