...
from eden.exceptions import AccessDenied, AccessError
from eden.http import _request_stack

import eden
import eden.tools
from eden.tests import common
from eden.service import common as auth, model
from eden.tools import DotDict
...
class TestXMLRPC(common.HttpCase):
    ...
    def test_xmlrpc_defaultdict_marshalling(self):
        ...
        self.patch(self.registry['res.users'], 'context_get',
                   eden.api.model(lambda *_: collections.defaultdict(int)))
