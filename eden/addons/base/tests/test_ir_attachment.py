...
from eden.tools.image import image_to_base64
...
class TestIrAttachment(TransactionCaseWithUserDemo):
    ...
    def test_10_image_autoresize(self):
        ...
        with Image.open(os.path.join(dir_path, 'eden.jpg'), 'r') as logo:
...
class TestPermissions(TransactionCaseWithUserDemo):
    ...
    def test_read_permission(self):
        ...
        attachment_admin = self.Attachments.with_user(eden.SUPERUSER_ID).create({'name': 'foo'})
        ...
        self.assertNotEqual(eden.SUPERUSER_ID, admin_user.id)
