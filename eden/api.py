...
"""The Eden API module defines Eden Environments and method decorators.
...
from eden.tools.misc import StackMap
...
def constrains(*args: str) -> Callable[[T], T]:
    ...
    Should raise :exc:`~eden.exceptions.ValidationError` if the
    validation failed.
...
def ondelete(*, at_uninstall):
    """
    Mark a method to be executed during :meth:`~eden.models.BaseModel.unlink`.
...
class Environment(Mapping):
    ...
    def __call__(self, cr=None, user=None, context=None, su=None):
        ...
        :type cursor: :class:`~eden.sql_db.Cursor`
    ...
    def user(self):
        ...
        :rtype: :class:`res.users record<~eden.addons.base.models.res_users.Users>`"""
    ...
    def company(self):
        ...
        :rtype: :class:`res.company record<~eden.addons.base.models.res_company.Company>`
    ...
    def companies(self):
        ...
        :rtype: :class:`res.company recordset<~eden.addons.base.models.res_company.Company>`
...
class Transaction:
    ...
    def __init__(self, registry):
        ...
        # temporary directories (managed in eden.tools.file_open_temporary_directory)
