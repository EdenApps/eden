...
def tag_quote(el):
    ...
    # eden, gmail and outlook automatic signature wrapper
    is_signature_wrapper = 'eden_signature_wrapper' in el_class or 'gmail_signature' in el_class or el_id == "Signature"
...
def plaintext2html(text, container_tag=None):
    ...
    html entities, using :func:`~eden.tools.misc.html_escape`.
...
def email_normalize(text, strict=True):
    ...
    within eden, this assumption is certain to fall short for international
...
def _normalize_email(email):
    ...
    introduction of smtp-utf8 within eden, this assumption is certain to fall
...
def encapsulate_email(old_email, new_email):
    ...
    * New From: notifications@edencloud.us
    * Output: "Admin" <notifications@edencloud.us>
    """
