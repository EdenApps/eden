...
Eden will use the SQL function 'unaccent' when available for the
...
import eden.modules
from eden.models import check_property_field_value_name, READ_GROUP_NUMBER_GRANULARITY
from eden.tools import Query, SQL, get_lang
from eden.tools.sql import pattern_to_translated_trigram_pattern, value_to_translated_trigram_pattern
...
def get_unaccent_wrapper(cr):
    ...
    return eden.modules.registry.Registry(cr.dbname).unaccent
