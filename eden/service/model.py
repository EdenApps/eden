...
from eden.tools import DotDict, lazy
from eden.tools.translate import translate_sql_constraint
...
def execute_cr(cr, uid, obj, method, *args, **kw):
    ...
    result = retrying(partial(eden.api.call_kw, recs, method, args, kw), env)
...
def retrying(func, env):
    ...
    :param eden.api.Environment env: The environment where the registry
